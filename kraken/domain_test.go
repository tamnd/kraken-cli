...
// HTTP behaviour is covered in kraken_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "kraken://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("kraken", "about")
	if err != nil || got.String() != "kraken://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want kraken://page/about", got.String(), err)
	}
}
